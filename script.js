...
async function processPDF(file) {
    try {
        ...
        const formDataInstance = new MyFormData(parsedData);
        ...
        // homeTelephoneField.setText(formDataInstance.personalInfo.cellphone || 'NÃO ENCONTRADO!');
        // nameField.setText(formDataInstance.personalInfo.fullName || 'NÃO ENCONTRADO!');
        // addressField.setText(formDataInstance.personalInfo.address || 'NÃO ENCONTRADO!');
        // stateField.setText(formDataInstance.personalInfo.city + ", " + formDataInstance.personalInfo.state || 'NÃO ENCONTRADO!');
        // countryField.setText(formDataInstance.personalInfo.country || 'NÃO ENCONTRADO!');
        ...
        // const fullName = formDataInstance.personalInfo.fullName;
        ...
        // addressField.setText(formDataInstance.personalInfo.address);
        // cityField.setText(formDataInstance.personalInfo.city);
        // stateField.setText(formDataInstance.personalInfo.state);
        // countryField.setText(formDataInstance.personalInfo.country);
        // cepField.setText(formDataInstance.personalInfo.cep);
        // cellphoneField.setText(formDataInstance.personalInfo.cellphone);
        ...
        // downloadLink.download = '3. W-8BEN—' + formDataInstance.personalInfo.fullName + '.pdf';
        ...
        // downloadLink1.download = '1. International Schwab Account Application—' + formDataInstance.personalInfo.fullName + '.pdf';
